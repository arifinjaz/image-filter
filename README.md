...
The can can filter bitmap images in following filters:

1) Grayscale: should take an image and turn it into a black-and-white version of the same image.
2) Reflect: function should take an image and reflect it horizontally.
